...
from .models import question, COLOR_MAP
import time
import psutil
...
def create_slides(preguntas_parseadas, excel_save_location, ppt_export_location, ppt_template_path):
    ...
    for question in preguntas_parseadas:
        ...
        slide_index = COLOR_MAP.get(question.tipo, 1)
...
def slide_selector(question) -> int:
    ...
    defined in COLOR_MAP. Defaults to 1 if not found.
    """
    tipo = question.tipo
    if not tipo:
