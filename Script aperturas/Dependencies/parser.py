...
def parse_data(df):
    ...
    questions = segmentar_dataframe(Stripped_df)
    ...
    ## If you need to use PowerPoint update logic
    #ppt_template_path = "path_to_template.pptx"
    #revincular_cuadros(ppt_template_path, file_save_location)
