...
def _canon_sets() -> Dict[str, Set[str]]:
    ...
    return {
        ...
        "Ordinal_5_corrupto": ord5_corrupto,
        "Ordinal_5_responsable": ord5_resp,
        "Ordinal_5_informado": ord5_info,
        "Ordinal_5_grave": ord5_grave,
        "Ordinal_5_acuerdo": ord5_acuerdo,
        "Ordinal_5_continuidad_cambio": ord5_contcambio,
